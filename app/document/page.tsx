...
export default function DocumentPage() {
    ...
    const indicatorSets = [
        [
            ...
            "Document metadata altered",
            "Suspicious stamp/marking pattern",
            "Text alignment inconsistency found",
        ],
        [
            "Possible forgery in critical areas",
            "Invalid document serialization",
            "Resolution mismatch with originals",
        ],
        [
            "Pixels show tampering traces",
            "Shadows & lighting mismatch",
            "AI reconstruction fingerprints found",
            "Document seal irregularities detected",
        ],
        [
            "No strong signs of manipulation",
            "Document properties appear authentic",
            "Consistent visual layout",
            "Valid metadata pattern",
        ],
    ];
    ...
    const getResult = (value: number | null) => {
        if (value === null)
            return {
                ...
                message: "Upload a document to begin verification",
        ...
        if (value >= 80)
            return {
                ...
                color: "red",
                title: "Fake / Manipulated Document",
                message: "High likelihood of forgery detected",
        ...
        if (value >= 50)
            return {
                ...
                message: "Possible signs of tampering detected",
                icon: (
        ...
        return {
            ...
            message: "No major signs of manipulation found",
    ...
    return (
        <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8">
                Upload a document to check authenticity
            </p>
