...
// import { ArrowLeft, Upload, PlayCircle, AlertCircle, CheckCircle, Clock } from "lucide-react";
...
//                 Upload a video to detect deepfakes, manipulations, and authenticity level
//             </p>

//             <div className="grid lg:grid-cols-2 gap-6">

//                 {/* LEFT SIDE — VIDEO UPLOAD BOX */}
//                 <div className="bg-white dark:bg-gray-800 border rounded-xl p-6 dark:border-gray-700">
//                     <h2 className="text-xl font-bold mb-4">Upload Video</h2>

//                     <label className="cursor-pointer">
//                         <div className="border-2 border-dashed rounded-lg p-12 text-center dark:bg-gray-700 dark:border-gray-600">
//                             <Upload className="w-16 h-16 mx-auto mb-4 text-gray-400" />

//                             <p className="font-medium mb-2">
//                                 {videoFile ? "Video Selected" : "Drag & Drop Video"}
//                             </p>
...
//                         className="w-full mt-4 px-6 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold disabled:opacity-50 hover:shadow-lg transition-all"
//                     >
...
//                             {/* Status Box */}
//                             <div className="text-center p-6 rounded-lg bg-green-100 border-2 border-green-500 dark:bg-green-900/20">
//                                 <CheckCircle className="w-16 h-16 text-green-500 mx-auto mb-3" />
//                                 <h3 className="text-2xl font-bold text-green-600 dark:text-green-400">Video is Real</h3>
...
//                                         "No lip-sync inconsistencies",
//                                         "Audio waveform matches lip movements",
//                                         "Video frames show natural blending",
//                                     ].map((item, idx) => (
...
export default function VideoAnalysisPage() {
    ...
    const indicatorSets = [
        [
            ...
            "Lip-sync mismatch identified",
            "Frame-level blending inconsistencies",
            "Deepfake-like texture distortion",
        ],
        [
            "Unnatural facial motion detected",
            "Voice-to-lip mismatch patterns",
            "GAN-generated temporal noise found",
        ],
        [
            "Irregular eye-blinking pattern",
            "Video frame compression mismatch",
            "Lighting inconsistency detected",
            "AI-reconstruction fingerprints detected",
        ],
        [
            "No major manipulation detected",
            "Stable lip-sync and motion flow",
            "Native camera lighting preserved",
            "Natural frame blending",
        ],
    ];
    ...
    const getResult = (value: number | null) => {
        if (value === null) {
            return {
                ...
                message: "Upload a video to start detection",
                icon: (
        ...
        if (value >= 80) {
            return {
                ...
                title: "Manipulated / Deepfake Video",
                message: "Strong signs of manipulation detected",
        ...
        if (value >= 50) {
            return {
                ...
                message: "Possible manipulation found",
                icon: (
    ...
    return (
        <div>
            ...
            <h1 className="text-3xl font-bold mb-2">Video Analysis</h1>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
                Upload a video to detect deepfakes, manipulations, and authenticity
            </p>
                        ...
                        <div className="border-2 border-dashed rounded-lg p-10 text-center dark:bg-gray-700 dark:border-gray-600">
                            {preview ? (
                                <video
                                    src={preview}
                                    controls
                                    className="mx-auto mb-4 max-h-60 rounded-xl"
                                />
                            ) : (
                                <>
                                    <Upload className="w-16 h-16 mx-auto mb-4 text-gray-400" />
