...
//                         className="w-full h-64 p-4 rounded-lg border bg-gray-50 border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none dark:bg-gray-700 dark:border-gray-600"
//                     />
//                     <button
...
//                             <div className="text-center p-6 rounded-lg bg-red-100 border-2 border-red-500 dark:bg-red-900/20">
...
//                             <button className="w-full px-6 py-3 rounded-lg border border-gray-300 dark:border-gray-600 font-semibold">
//                                 Download Detailed Report
//                             </button>
//                         </div>
//                     ) : (
//                         <div className="flex items-center justify-center h-64 text-gray-400">Enter text and click analyze to see results</div>
//                     )}
//                 </div>
//             </div>
//         </div>
